...
def parse_args():
    ...
    parser.add_argument('--scrpath', default='runs/val/dotav2_test_split4/obb_predictions_Txt', help='test config file path')
    parser.add_argument('--dstpath', default='op', help='checkpoint file')
